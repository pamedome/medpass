...
export const allMemberDocuments: Record<string, any[]> = {
  '1': [ // Jane Doe
    ...
    },
    {
      ...
      images: [
          ...
          {
            src: placeholderImages.dentalXray2.src,
            width: placeholderImages.dentalXray2.width,
            height: placeholderImages.dentalXray2.height,
            alt: placeholderImages.dentalXray2.alt,
            hint: placeholderImages.dentalXray2.hint,
          },
        ],
    },
    {
    ...
    },
    {
      ...
      images: [
        ...
        {
          src: placeholderImages.ultrasoundScan2.src,
          width: placeholderImages.ultrasoundScan2.width,
          height: placeholderImages.ultrasoundScan2.height,
          alt: placeholderImages.ultrasoundScan2.alt,
          hint: placeholderImages.ultrasoundScan2.hint,
        },
      ],
    },
  ],
  '2': [ // John Doe
    ...
    },
    {
      ...
      type: 'Imaging Report',
      date: '2024-02-10',
      tags: ['imaging', 'neurology', 'ct-scan'],
      patientInfo: { name: 'John Doe', dob: '1988-11-15', patientId: 'JD-54321' },
      reportInfo: { reportId: 'RPT-98775', issuedBy: 'Dr. Ray Arnold', facility: 'Central City Clinic', time: '04:00 PM' },
      vitalSigns: {},
      labResults: [],
      assessment: 'CT scan of the head without contrast performed due to complaints of chronic headaches. The brain parenchyma is unremarkable. Ventricles are normal in size and configuration. No evidence of acute intracranial hemorrhage or mass effect.',
      recommendations: 'Findings do not explain headaches. Recommend follow-up with neurology for further evaluation, possibly including an MRI with contrast for more detailed imaging.',
      images: [
        {
          src: placeholderImages.ctScan.src,
          width: placeholderImages.ctScan.width,
          height: placeholderImages.ctScan.height,
          alt: placeholderImages.ctScan.alt,
          hint: placeholderImages.ctScan.hint,
        },
        {
          src: placeholderImages.ctScan2.src,
          width: placeholderImages.ctScan2.width,
          height: placeholderImages.ctScan2.height,
          alt: placeholderImages.ctScan2.alt,
          hint: placeholderImages.ctScan2.hint,
        },
      ],
    },
  ],
  ...
  '4': [ // Jonna Doe
    ...
    },
    {
      ...
      images: [
          ...
          {
            src: placeholderImages.chestXray2.src,
            width: placeholderImages.chestXray2.width,
            height: placeholderImages.chestXray2.height,
            alt: placeholderImages.chestXray2.alt,
            hint: placeholderImages.chestXray2.hint,
          },
        ],
    },
  ],
