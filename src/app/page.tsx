...
const GooglePlayBadge = (props: React.SVGProps<SVGSVGElement>) => (
    <svg width="135" height="40" viewBox="0 0 135 40" fill="none" {...props}>
      ...
      <path d="M74.9658 21.2201L74.2335 21.3588C74.135 21.0582 73.8196 20.8975 73.5266 20.8975C73.1584 20.8975 72.8913 21.107 72.8913 21.4067C72.8913 21.7224 73.1584 21.9319 73.6661 22.0447L74.4444 22.2542C75.4324 22.4959 75.9302 22.9937 75.9302 23.8346C75.9302 24.8872 75.0252 25.5414 73.8679 25.5414C72.6302 25.5414 71.8293 24.9666 71.6052 24.1578L72.4799 23.8906C72.6236 24.4654 73.0565 24.9827 73.8679 24.9827C74.4444 24.9827 74.9096 24.7088 74.9096 24.3245C74.9096 24.0088 74.6587 23.8159 74.1188 23.6873L73.3526 23.4944C72.3011 23.2366 71.8293 22.7544 71.8293 21.9135C71.8293 20.9135 72.6463 20.2593 73.7875 20.2593C74.4444 20.2593 74.8613 20.5226 74.9658 21.2201Z" fill="white"/>
